...
def main():
    ...
    wandb.init(project="Canopies Behavioural Cloning", config=config, name=f"{config.task}_stable")
    ...
    agent.encoder.load_model('/home/adriano/Desktop/behavioural_cloning/params/model_encode.pth')
